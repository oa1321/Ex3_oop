...
class TestDiGraph(TestCase):
    ...
    def test_get_all_v(self):
        ...
        self.assertEqual(0, temp.get(0).get_key())
        point2 = (35.18958953510896, 32.10785303529412, 0.0)
        graph.add_node(1, point2)
        self.assertEqual(1, temp.get(1).get_key())
    ...
    def test_all_in_edges_of_node(self):
        ...
        self.assertTrue(temp.__contains__(point0))
        self.assertTrue(temp.__contains__(point2))
